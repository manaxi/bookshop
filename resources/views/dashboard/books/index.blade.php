            ...
            <div class="mt-3 ml-4" style="width: 12rem;">
                ...
                <div class="card-books-grid">
                    ...
                    <div class="info-wrap">
                        ...
                        <div class="actions">
                            <div class="pull-left">
                                <a href="{{ route('dashboard.books.edit',$book->id) }}" class="btn btn-secondary">Edit</a>
                            </div>
                            <div class="pull-right">
                                <form action="{{ route('dashboard.books.destroy', $book->id) }}" method="POST" onsubmit="return confirm('Are your sure?');"
